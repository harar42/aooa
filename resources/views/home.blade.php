                ...
                <div class="text-white text-center d-flex align-items-center rgba-black-light py-5 px-4" style="height: 350px;">
                    <div>
                        ...
                        <p>{{ $partner->description }}</p>
                                ...
                                <a href="<?php echo "https://www.google.com/maps/dir/?api=1&destination=".$partner->latitude.",".$partner->longitude ?>" class="btn btn-sm  btn-success"><i class="fas fa-car"></i> J'y vais</a>
                    </div>
                </div>
