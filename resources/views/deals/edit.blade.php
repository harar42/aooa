...
@section('content')
    <div class="container">
        ...
        <form method="post" action="{{route('partners.update', $deal->id)}}" enctype="multipart/form-data" class="border border-light p-5 md-form" >
            @csrf
            @method('PATCH')


            <h1 class="mb-5"> Modifier un deal </h1>
